...
let game = {
  ...
  render() {
    ...
    div_predicao.innerHTML = this.predicao;
    div_resultado.innerHTML = this.resultado;
    ...
    div_valor_aposta.innerHTML = Money(this.valor_aposta);
    // div_historic.innerHTML = this.historic;
  },
  ...
  choice(n) {
    ...
    document.querySelector(".cubo").classList.add("cubo-vel-2");
